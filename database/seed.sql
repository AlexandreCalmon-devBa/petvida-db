...
-- ATENÇÃO: Execute APÓS schema.sql
-- =============================================================================
...
-- Espécies
-- -----------------------------------------------------------------------------
INSERT IGNORE INTO especies (id, nome) VALUES
(1, 'Cachorro'),
(2, 'Gato'),
(3, 'Pássaro'),
(4, 'Peixe'),
...
-- -----------------------------------------------------------------------------
-- Animais  (especie_id referencia tabela especies)
-- -----------------------------------------------------------------------------
...
( 1,  1, 1, '2025-01-05 09:00:00', 'Vacinação de reforço.',                        180.00, 'concluida'),
( 2,  2, 2, '2025-01-07 10:30:00', 'Exame de pele e tratamento tópico.',           220.00, 'concluida'),
( 3,  3, 3, '2025-01-08 14:00:00', 'Avaliação ortopédica e fisioterapia.',         350.00, 'concluida'),
( 4,  4, 1, '2025-01-09 11:15:00', 'Check-up geral e orientações nutricionais.',   160.00, 'concluida'),
( 5,  5, 2, '2025-01-10 15:45:00', 'Exame respiratório de rotina.',               140.00, 'concluida'),
( 6,  6, 3, '2025-01-11 13:00:00', 'Análise de água e troca de tanque.',          120.00, 'concluida'),
( 7,  7, 1, '2025-01-12 10:00:00', 'Avaliação de casco e alimentação.',           210.00, 'concluida'),
( 8,  8, 2, '2025-01-13 09:30:00', 'Alergia de pele leve.',                       230.00, 'concluida'),
( 9,  9, 3, '2025-01-14 16:00:00', 'Consulta para ajuste de pH e bolhas.',        110.00, 'concluida'),
(10, 10, 1, '2025-01-15 08:45:00', 'Exame de asas e orientação de higiene.',      150.00, 'concluida'),
(11, 11, 2, '2025-01-16 14:30:00', 'Avaliação de pelagem e recomendação de dieta.',190.00, 'concluida'),
(12, 12, 3, '2025-01-17 11:00:00', 'Revisão de cirurgia e curativo.',             280.00, 'concluida'),
(13, 13, 1, '2025-01-18 12:30:00', 'Verificação de umidade e tratamento.',        200.00, 'em_atendimento'),
(14, 14, 2, '2025-01-19 15:00:00', 'Check-up de rotina.',                         130.00, 'agendada'),
(15, 15, 3, '2025-01-20 10:15:00', 'Exame de bico e vacinação.',                  170.00, 'agendada'),
(16,  1, 2, '2025-01-21 09:00:00', 'Retorno por ferimento leve.',                 200.00, 'cancelada'),
(17,  4, 3, '2025-01-22 14:00:00', 'Exame de sanitização bucal.',                 180.00, 'pendente'),
(18,  7, 1, '2025-01-23 16:30:00', 'Acompanhamento de alimentação.',              190.00, 'em_atendimento'),
(19, 10, 2, '2025-01-24 11:45:00', 'Consulta preventiva.',                        145.00, 'agendada'),
(20, 12, 3, '2025-01-25 13:15:00', 'Controle pós-operatório.',                    275.00, 'agendada');
